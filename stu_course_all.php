	...
	<div class="middle_table">
        ...
        <table cellspacing="0" cellpadding="0" width="700px" border="1" class="table_content table_color table_color_center">
            ...
            <?php for($i = 0; $i < $total; $i++){ ?>
			 ...
			 <td><a href="./Admin/insert_course.php?id=<?php echo $result[$i]['id']; ?> && num1=<?php echo $result[$i]['limit_num']; ?> && num2=<?php echo $couresult[0]['count(id)']; ?> " style="margin-left: 0px;border: 1px solid #51C1AE;background: #51C1AE;color:#fff;border-radius: 10px;">添加</a></td>
			 </tr>
			 <?php } ?>
        </table>
	</div>
